...
class STARTER6P extends StatefulWidget {
  const STARTER6P({super.key});

  @override
  State<STARTER6P> createState() => _STARTER6PState();
}

class _STARTER6PState extends State<STARTER6P> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Royal Canin Medium Starter Pellet Dog Food,4Kg',
                style: TextStyle(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Easy rehydration kibbles easily rehydrate to a porridge like consistency that is very palatable for both the mother and her weaning puppies', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
