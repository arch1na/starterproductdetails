...
class STARTER9P extends StatefulWidget {
  const STARTER9P({super.key});

  @override
  State<STARTER9P> createState() => _STARTER9PState();
}

class _STARTER9PState extends State<STARTER9P> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Grain Zero Signature Starter Mother & Puppy Dog Dry Food - 3 Kg',
                style: TextStyle(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Hypoallergenic complete nutrition dog food', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Great for mother dogs and weaning puppies', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Made with real chicken, eggs and vegetables', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text(
                '- Includes 48% meat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text(
                '- Contains no corn, wheat or soya', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
