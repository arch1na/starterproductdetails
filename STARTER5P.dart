...
class STARTER5P extends StatefulWidget {
  const STARTER5P({super.key});

  @override
  State<STARTER5P> createState() => _STARTER5PState();
}

class _STARTER5PState extends State<STARTER5P> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Royal Canin Mini Starter Mother & Puppy Dry Food, 4kg',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                '- breed_recommendation: small', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text(
                '- material_features:non-vegetarian', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- target_audience_keywords:dogs',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              ...
              child: Text('- breed_recommendation:small', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
