...
class STARTER4P extends StatefulWidget {
  const STARTER4P({super.key});

  @override
  State<STARTER4P> createState() => _STARTER4PState();
}

class _STARTER4PState extends State<STARTER4P> {
  @override
        ...
        child: Column(
          children: [
              ...
              child: Padding(
                padding: const EdgeInsets.only(left: 20),
                  child: Padding(
                    ...
                    child: Image.asset('assets/images/canine1.png'),
                  ),
              ),
            ),
            Padding(
              padding: const EdgeInsets.only(left: 10),
              child: Text('Canine Creek Starter Dry Dog Food Ultra Premium - 4kg',
                style: TextStyle(
            ...
            Padding(
              ...
              child: Text(
                '- Promotes healthy muscle growth', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Healthy skin and coat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              ...
              child: Text('- Improves bone and joint health',
                style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
            ...
            Padding(
              ...
              child: Text('- Promotes dental health', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
