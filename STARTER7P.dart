...
class STARTER7P extends StatefulWidget {
  const STARTER7P({super.key});

  @override
  State<STARTER7P> createState() => _STARTER7PState();
}

class _STARTER7PState extends State<STARTER7P> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Mankind Petstar Starter Mother & Baby Dog Dry Food',
                style: TextStyle(
            ...
            Row(
              children: [
                ...
                Padding(
                    padding: EdgeInsets.only(left: 8, bottom: 120),
                    child: Column(
                      children: [
                        Text(
                          'Generic\nChicken\nNon Vegetarian\nStarter\nDog Food',
            ...
            Padding(
              ...
              child: Text(
                '- Dehydrated chicken maize wheat chicken fat hydrolyzed chicken peas Dehydrated BREWER YEAST minerals milk powder salmon oil chicory extract manno oligosaccharides ashwagandha sliybum marianum best food all dog', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
