...
class STARTER8P extends StatefulWidget {
  const STARTER8P({super.key});

  @override
  State<STARTER8P> createState() => _STARTER8PState();
}

class _STARTER8PState extends State<STARTER8P> {
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                'Smart Heart Mother & Puppy Starter Dog Dry Food',
                style: TextStyle(
            ...
            Row(
              children: [
                ...
                Text('  ₹3,210', style: TextStyle(
                    color: Colors.black,
                    fontWeight: FontWeight.bold,
                    fontFamily: 'Inter',
                    fontSize: 15
                ),),
                Text(' 4% Off', style: TextStyle(
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Enhanced Brain Function: DHA (from fish oil) and choline (from lecithin) for enhanced brain and nervous system function', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text('- Healthy Heart: Omega-3 fatty acids from fish oil for a healthy heart', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
            ...
            Padding(
              padding: const EdgeInsets.only(left: 30),
              child: Text(
                '- Healthy Skin and Coat:  Balanced Omega 3 & 6 essential fatty acids for a healthy skin and shiny coat', style: TextStyle(
                  color: Colors.black,
                  fontFamily: 'AbhayaLibre',
                  fontSize: 16
              ),),
